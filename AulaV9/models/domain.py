...
class Curso:
    ...
    def asignar_horario(self, horario: Horario): self._horario = horario
    def asignar_modalidad(self, modalidad: Modalidad): self._modalidad = modalidad
    def asignar_docente(self, email: str): self.docente_email = email
