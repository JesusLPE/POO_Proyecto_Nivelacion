...
def construir(parent, usuario, repo):
    ...
    tabs = [
        ...
        ("  📄 Auditoría  ",      lambda f: _tab_auditoria(f, repo, usuario)),
...
def _tab_auditoria(parent, repo, usuario):
    """Panel de reportes con cajón de selección para el administrador.
    ...
    generan visualmente sin guardarse.
    """
    panel_reportes_drawer(parent, usuario, repo, guardar_historial=False)
