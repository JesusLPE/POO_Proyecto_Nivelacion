...
from ui.reporte_drawer import panel_reportes_drawer
...
def _tab_reportes(parent, repo, usuario):
    """Panel de reportes con cajón de selección.
    
    Integra panel_reportes_drawer para permitir elegir entre múltiples tipos
    de reportes (calificaciones, matrículas, tareas, promedios, etc.) que se
    generan visualmente sin guardarse automáticamente, aunque sí se registran
    en el historial para que el administrador pueda verlos.
    """
    panel_reportes_drawer(parent, usuario, repo, guardar_historial=True)
