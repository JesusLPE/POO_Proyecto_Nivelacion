...
class Curso:
    def __init__(self, id: int, nombre: str, duracion_semanas: int, total_horas: int, carrera: str = ""):
        self._id = id
        self._nombre = nombre
        ...
        self.carrera = carrera  # carrera a la que pertenece este curso
    ...
    @property
    def modalidad(self): return self._modalidad
