...
Modelo de datos puro para el subsistema de reportes (patrón Builder).

- `SeccionReporte`  : un bloque tabular dentro de un reporte.
- `Reporte`         : el PRODUCTO final construido paso a paso por los
                      builders de `services/reporte_service.py`. No
                      contiene lógica de negocio, solo datos listos
                      para que la UI los renderice.
