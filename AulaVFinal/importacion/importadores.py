...
# POO: Clase | Herencia: implementa (hereda de) IImportador
# POO: Polimorfismo con interfaces -> intercambiable con ExcelImportador
class CSVImportador(IImportador):
    """Lee archivos .csv usando encabezados en la primera fila."""

    # POO: Polimorfismo -> misma firma leer(), comportamiento distinto (CSV vs Excel)
...
# POO: Clase | Herencia: implementa IImportador
