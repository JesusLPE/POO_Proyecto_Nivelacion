...
# POO: Clase | Patrón de diseño CREACIONAL: Factory Method / Simple Factory
# SOLID -> OCP: agregar un nuevo formato (ej. .json) solo requiere llamar a
# registrar(), sin tocar el método crear()
class ImportadorFactory:
    ...
    # POO: Método de clase (@classmethod) -> crea y devuelve el importador
    # concreto adecuado (Estudiante no conoce cuál se usará, solo el tipo IImportador)
    @classmethod
